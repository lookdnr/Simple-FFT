...
File: main script which implements the routine
Author: Luke Dinsdale
CID: 02285881

This is the main script to be run which invokes the entire process:

- Reads file, receives user parameters
- Preps data and performs the Cooley-Tukey FFT algorithm
- Integrates in the Fourier domain and performs relevant inverse FTs
- Creates directory (where necesary) and writes to file
*/
